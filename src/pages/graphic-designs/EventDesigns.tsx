  ...
  return (
    ...
    >
      <div>
        ...
        <h2 className="text-2xl font-display font-semibold mt-10 mb-4">Banner Designs</h2>
        <h2 className="text-2xl font-display font-semibold mt-10 mb-4">Demo Station Designs</h2>
        <h2 className="text-2xl font-display font-semibold mt-10 mb-4">Stationary Deliverables</h2>
        <h2 className="text-2xl font-display font-semibold mt-10 mb-4">Collateral in Context</h2>
      </div>
