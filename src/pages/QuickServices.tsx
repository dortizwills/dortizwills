    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
        ...
        <div className="md:col-span-8">
          ...
          <div className="bg-gray-700 rounded-lg aspect-video flex items-center justify-center mb-6">
            <p className="text-gray-300">Express Lane lofi.gif (placeholder)</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
        ...
        <div className="md:col-span-8">
          ...
          <img 
            src="/lovable-uploads/New+Directions+1.png"
            alt="New Directions 1" 
            className="w-full rounded-lg mb-6"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
        ...
        <div className="md:col-span-8">
          ...
          <img 
            src="/lovable-uploads/New+Directions+2.png"
            alt="New Directions 2" 
            className="w-full rounded-lg mb-6"
          />
        </div>
      </div>
